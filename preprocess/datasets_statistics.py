...
parser.add_argument(
    "--data-dir", type=str,default="/home/liqian/research/Multi_domain_CRC_zhaoke/train_dataset/S06", help="path to dataset(ImageFolder form)"
)
parser.add_argument("--save-dir", type=str, default="preprocess", help="path to save dataset")
parser.add_argument(
    "--dataset-name", type=str, default="S06_LAB", metavar="DIR", help="dataset output_name"
)
