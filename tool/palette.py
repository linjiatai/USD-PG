...
## Multi-domain CRC
palette = [0]*768
palette[0:3] = [192, 192, 192] #ADI
palette[3:6] = [255, 255, 255] #BACK
palette[6:9] = [160, 32, 240]  #DEB
palette[9:12] = [0, 0, 255]    #LYM
palette[12:15] = [0, 255, 255] #MUC
palette[15:18] = [0, 255, 0]   #MUS
palette[18:21] = [255, 255, 0] #NORM
palette[21:24] = [255, 97, 0]  #STR
palette[24:27] = [255, 0, 0]   #TUM