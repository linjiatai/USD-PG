...
class MoCo(nn.Module):
    ...
    def forward(self, im_q1, im_q2, im_k):
        """
        Input:
        ...
        l_pos2 = torch.einsum("nc,nc->n", [q2, k]).unsqueeze(-1)
        l_neg2 = torch.einsum("nc,ck->nk", [q2, self.queue.clone().detach()])
        ...
        return logits, logits2, labels, labels2
